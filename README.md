...
New module migrations generated by `generate-module.php` are placed in `src/Migration/<Module>/` and registered in `moduleConnections` automatically (connection `default`, or the value of `--db`).
