...
use App\Shared\Core\Exception\NoChangesException;
...
final readonly class ExceptionResponderFactory
{
    ...
    private function shouldShowErrorDetails(\Throwable $exception): bool
    {
        ...
        // Business exception dari src/Shared/Core/Exception tidak perlu detail
        $exceptionClass      = $exception::class;
        $isBusinessException = \str_contains($exceptionClass, 'App\\Shared\\Core\\Exception');
