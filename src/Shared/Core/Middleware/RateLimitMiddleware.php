...
// PSR Interfaces
use App\Shared\Core\Exception\TooManyRequestsException;
...
final class RateLimitMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        if ($currentCount >= $this->maxRequests) {
            ...
            throw new TooManyRequestsException(translate: Message::create(key: 'rate_limit.exceeded', params: ['seconds' => $this->windowSize, 'limit' => $this->maxRequests, 'remaining' => 0, 'reset' => $resetTime, 'retry_after' => $this->windowSize]));
        }
