...
// Shared Layer
use App\Shared\Core\Exception\UnauthorizedException;
...
final class JwtMiddleware implements MiddlewareInterface
{
     ...
     * @param array         $publicPaths   Paths that bypass JWT validation
     *
     * @example
     ...
     *     actorProvider: $container->get(ActorProvider::class),
     *     currentUser: $container->get(CurrentUser::class),
     *     publicPaths: $container->get('jwt.publicPaths')
     * );
     * @example
     ...
     *         actorProvider: $container->get(ActorProvider::class),
     *         currentUser: $container->get(CurrentUser::class),
     *         publicPaths: $container->get('config')['app/jwt']['publicPaths'] ?? []
     *     );
     * });
     */
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        try {
            ...
            throw new UnauthorizedException(translate: Message::create(key: 'auth.invalid_token', params: ['error' => $e->getMessage()]));
        }
