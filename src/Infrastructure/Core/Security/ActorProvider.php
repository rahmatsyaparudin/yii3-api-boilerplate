    ...
    public function fromToken(object $claims): Actor
    {
        ...
        if (isset($claims->user) && \is_object($claims->user)) {
            ...
            if (!isset($user->username)) {
                throw new UnauthorizedException(translate: Message::create(key: 'auth.missing_claim', params: ['claim' => 'user.username']));
            }
        ...
        throw new UnauthorizedException(translate: Message::create(key: 'auth.missing_claim', params: ['claim' => 'username']));
    }
